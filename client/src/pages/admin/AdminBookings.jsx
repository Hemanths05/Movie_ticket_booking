...
const AdminBookings = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const response = await axios.get('https://hemanthmovies.duckdns.org/api/bookings');
  ...
  const handleCancelBooking = async () => {
    try {
      ...
      await axios.put(`https://hemanthmovies.duckdns.org/api/bookings/updateStatus/${selectedBookingId}`, {
        status: 'cancelled'
      });

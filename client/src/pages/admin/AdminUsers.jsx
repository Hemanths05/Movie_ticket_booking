...
const AdminUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get('https://movie-ticket-booking-0igc.onrender.com/api/auth');
  ...
  const handleDelete = async (userEmail) => {
    if (window.confirm('Are you sure you want to delete this user?')) {
      try {
        await axios.delete(`https://movie-ticket-booking-0igc.onrender.com/api/auth/${userEmail}`);
        fetchUsers(); 
      } catch (error) {
          ...
          <div className="bg-gray-800 p-8 rounded-lg w-full max-w-md">
            ...
            <div className="flex justify-end mt-6 space-x-4">
              ...
              <button
                onClick={async () => {
                  try {
                    await axios.post('https://movie-ticket-booking-0igc.onrender.com/api/auth/register', newUser);
                    setShowModal(false);
          ...
          <div className="bg-gray-800 p-8 rounded-lg w-full max-w-md">
            ...
            <div className="flex justify-end mt-6 space-x-4">
              ...
              <button
                onClick={async () => {
                  try {
                    await axios.put(`https://movie-ticket-booking-0igc.onrender.com/api/auth/edit/${editUser.email}`, editUser);

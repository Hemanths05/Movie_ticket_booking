...
const AdminMovies = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const res = await axios.get('http://13.50.187.158:5000//api/admin/movies');
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`http://13.50.187.158:5000//api/admin/movies/delete/${id}`);
          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-xl text-black">
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  const res = await axios.post('http://13.50.187.158:5000//api/admin/movies/add', newMovie);
          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-xl text-black">
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  await axios.put(`http://13.50.187.158:5000//api/admin/movies/update/${selectedMovie._id}`, updatedMovie);

...
const AdminMovies = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`http://localhost:5000/api/admin/movies/delete/${id}`);
          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-xl text-black">
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  const res = await axios.post('http://localhost:5000/api/admin/movies/add', newMovie);
          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-xl text-black">
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  await axios.put(`http://localhost:5000/api/admin/movies/update/${selectedMovie._id}`, updatedMovie);

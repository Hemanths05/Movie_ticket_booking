...
const BookingPage = () => {
  ...
  useEffect(() => {
    ...
    try{
        setLoading(true);
        const movieRes = await fetch(`https://hemanthmovies.duckdns.org/api/movies/${movieId}`);
      ...
      const theaterRes = await fetch(`https://hemanthmovies.duckdns.org/api/theaters/${selectedShowtime.theaterId}`);
